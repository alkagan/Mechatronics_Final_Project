...
${OBJECTDIR}/_ext/580189257/TapeService.o: C:/Users/alkagan/Mechatronics_Final_Project/StateMachine.X/TapeService.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/580189257" 
	@${RM} ${OBJECTDIR}/_ext/580189257/TapeService.o.d 
	@${RM} ${OBJECTDIR}/_ext/580189257/TapeService.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/580189257/TapeService.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -I"." -I"C:/CMPE118/include" -MMD -MF "${OBJECTDIR}/_ext/580189257/TapeService.o.d" -o ${OBJECTDIR}/_ext/580189257/TapeService.o C:/Users/alkagan/Mechatronics_Final_Project/StateMachine.X/TapeService.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
