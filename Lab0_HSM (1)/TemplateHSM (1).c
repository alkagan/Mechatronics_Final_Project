...
static TemplateHSMState_t CurrentState = Light; // <- change enum name to match ENUM
...
ES_Event RunTemplateHSM(ES_Event ThisEvent) {
    ...
    switch (CurrentState) {
        case Light: // If current state is initial Pseudo State
        ...
        case Dark: // in the first state, replace this with correct names
